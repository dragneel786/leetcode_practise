<h2><a href="https://leetcode.com/problems/finding-3-digit-even-numbers/">2094. Finding 3-Digit Even Numbers</a></h2><h3>Easy</h3><hr><div><p>You are given an integer array <code>digits</code>, where each element is a digit. The array may contain duplicates.</p>
...
<pre style="position: relative;"><strong>Input:</strong> digits = [2,1,3,0]
...
<pre style="position: relative;"><strong>Input:</strong> digits = [2,2,8,8,2]
...
<pre style="position: relative;"><strong>Input:</strong> digits = [3,7,5]

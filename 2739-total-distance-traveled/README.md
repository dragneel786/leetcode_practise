...
<pre style="position: relative;"><strong>Input:</strong> mainTank = 5, additionalTank = 10
...
<pre style="position: relative;"><strong>Input:</strong> mainTank = 1, additionalTank = 2

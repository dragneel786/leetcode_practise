...
<pre style="position: relative;"><strong>Input:</strong> nums = [4,7,9,10], k = 1
...
<pre style="position: relative;"><strong>Input:</strong> nums = [4,7,9,10], k = 3
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,4], k = 3

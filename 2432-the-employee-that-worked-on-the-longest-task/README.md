<h2><a href="https://leetcode.com/problems/the-employee-that-worked-on-the-longest-task/">2432. The Employee That Worked on the Longest Task</a></h2><h3>Easy</h3><hr><div><p>There are <code>n</code> employees, each with a unique id from <code>0</code> to <code>n - 1</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> n = 10, logs = [[0,3],[2,5],[0,9],[1,15]]
...
<pre style="position: relative;"><strong>Input:</strong> n = 26, logs = [[1,1],[3,7],[2,12],[7,17]]
...
<pre style="position: relative;"><strong>Input:</strong> n = 2, logs = [[0,10],[1,20]]

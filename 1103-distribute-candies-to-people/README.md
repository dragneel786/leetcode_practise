<h2><a href="https://leetcode.com/problems/distribute-candies-to-people/">1103. Distribute Candies to People</a></h2><h3>Easy</h3><hr><div><p>We distribute some&nbsp;number of <code>candies</code>, to a row of <strong><code>n =&nbsp;num_people</code></strong>&nbsp;people in the following way:</p>
...
<pre style="position: relative;"><strong>Input:</strong> candies = 7, num_people = 4
...
<pre style="position: relative;"><strong>Input:</strong> candies = 10, num_people = 3

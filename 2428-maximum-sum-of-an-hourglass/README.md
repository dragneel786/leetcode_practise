<h2><a href="https://leetcode.com/problems/maximum-sum-of-an-hourglass/">2428. Maximum Sum of an Hourglass</a></h2><h3>Medium</h3><hr><div><p>You are given an <code>m x n</code> integer matrix <code>grid</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> grid = [[6,2,1,3],[4,2,1,5],[9,2,8,7],[4,1,2,9]]
...
<pre style="position: relative;"><strong>Input:</strong> grid = [[1,2,3],[4,5,6],[7,8,9]]

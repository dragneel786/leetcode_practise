<h2><a href="https://leetcode.com/problems/maximum-enemy-forts-that-can-be-captured/">2511. Maximum Enemy Forts That Can Be Captured</a></h2><h3>Easy</h3><hr><div><p>You are given a <strong>0-indexed</strong> integer array <code>forts</code> of length <code>n</code> representing the positions of several forts. <code>forts[i]</code> can be <code>-1</code>, <code>0</code>, or <code>1</code> where:</p>
...
<pre style="position: relative;"><strong>Input:</strong> forts = [1,0,0,-1,0,0,0,0,1]
...
<pre style="position: relative;"><strong>Input:</strong> forts = [0,0,1,-1]

...
<pre style="position: relative;"><strong>Input:</strong> root = [5,1,2,3,null,6,4], startValue = 3, destValue = 6
...
<pre style="position: relative;"><strong>Input:</strong> root = [2,1], startValue = 2, destValue = 1

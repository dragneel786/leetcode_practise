<h2><a href="https://leetcode.com/problems/k-items-with-the-maximum-sum/">2600. K Items With the Maximum Sum</a></h2><h3>Easy</h3><hr><div><p>There is a bag that consists of items, each item&nbsp;has a number <code>1</code>, <code>0</code>, or <code>-1</code> written on it.</p>
...
<pre style="position: relative;"><strong>Input:</strong> numOnes = 3, numZeros = 2, numNegOnes = 0, k = 2
...
<pre style="position: relative;"><strong>Input:</strong> numOnes = 3, numZeros = 2, numNegOnes = 0, k = 4

<h2><a href="https://leetcode.com/problems/design-phone-directory/">379. Design Phone Directory</a></h2><h3>Medium</h3><hr><div><p>Design a phone directory that initially has <code>maxNumbers</code> empty slots that can store numbers. The directory should store numbers, check if a certain slot is empty or not, and empty a given slot.</p>

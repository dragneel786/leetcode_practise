...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,2,5,4], threshold = 5
...
Hence, the answer is the length of the subarray, 3. We can show that 3 is the maximum possible achievable length.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> nums = [1,2], threshold = 2
...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,3,4,5], threshold = 4
<strong>Output:</strong> 3

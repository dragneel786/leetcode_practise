...
<pre style="position: relative;"><strong>Input:</strong> hand = [1,2,3,6,2,3,4,7,8], groupSize = 3
...
<pre style="position: relative;"><strong>Input:</strong> hand = [1,2,3,4,5], groupSize = 4

...
<pre style="position: relative;"><strong>Input:</strong> words = ["alice","bob","charlie"], s = "abc"
...
<pre style="position: relative;"><strong>Input:</strong> words = ["an","apple"], s = "a"
...
<pre style="position: relative;"><strong>Input:</strong> words = ["never","gonna","give","up","on","you"], s = "ngguoy"
<strong>Output:</strong> true

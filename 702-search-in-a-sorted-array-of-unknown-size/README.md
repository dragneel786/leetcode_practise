<h2><a href="https://leetcode.com/problems/search-in-a-sorted-array-of-unknown-size/">702. Search in a Sorted Array of Unknown Size</a></h2><h3>Medium</h3><hr><div><p>This is an <strong><em>interactive problem</em></strong>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> secret = [-1,0,3,5,9,12], target = 9
...
<pre style="position: relative;"><strong>Input:</strong> secret = [-1,0,3,5,9,12], target = 2

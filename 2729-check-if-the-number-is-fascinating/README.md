<h2><a href="https://leetcode.com/problems/check-if-the-number-is-fascinating/">2729. Check if The Number is Fascinating</a></h2><h3>Easy</h3><hr><div><p>You are given an integer <code>n</code> that consists of exactly <code>3</code> digits.</p>
...
<pre style="position: relative;"><strong>Input:</strong> n = 192
...
<pre style="position: relative;"><strong>Input:</strong> n = 100

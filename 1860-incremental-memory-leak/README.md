<h2><a href="https://leetcode.com/problems/incremental-memory-leak/">1860. Incremental Memory Leak</a></h2><h3>Medium</h3><hr><div><p>You are given two integers <code>memory1</code> and <code>memory2</code> representing the available memory in bits on two memory sticks. There is currently a faulty program running that consumes an increasing amount of memory every second.</p>
...
<pre style="position: relative;"><strong>Input:</strong> memory1 = 2, memory2 = 2
...
<pre style="position: relative;"><strong>Input:</strong> memory1 = 8, memory2 = 11

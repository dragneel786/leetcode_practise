<h2><a href="https://leetcode.com/problems/maximum-strong-pair-xor-i/">2932. Maximum Strong Pair XOR I</a></h2><h3>Easy</h3><hr><div><p>You are given a <strong>0-indexed</strong> integer array <code>nums</code>. A pair of integers <code>x</code> and <code>y</code> is called a <strong>strong</strong> pair if it satisfies the condition:</p>
...
<pre style="position: relative;"><strong>Input:</strong> nums = [10,100]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [5,6,25,30]
<strong>Output:</strong> 7

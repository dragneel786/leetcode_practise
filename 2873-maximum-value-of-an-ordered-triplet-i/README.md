<h2><a href="https://leetcode.com/problems/maximum-value-of-an-ordered-triplet-i/">2873. Maximum Value of an Ordered Triplet I</a></h2><h3>Easy</h3><hr><div><p>You are given a <strong>0-indexed</strong> integer array <code>nums</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> nums = [12,6,1,2,7]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,10,3,4,19]

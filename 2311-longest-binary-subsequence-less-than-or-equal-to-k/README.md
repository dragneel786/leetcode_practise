<h2><a href="https://leetcode.com/problems/longest-binary-subsequence-less-than-or-equal-to-k/">2311. Longest Binary Subsequence Less Than or Equal to K</a></h2><h3>Medium</h3><hr><div><p>You are given a binary string <code>s</code> and a positive integer <code>k</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> s = "1001010", k = 5
...
<pre style="position: relative;"><strong>Input:</strong> s = "00101001", k = 1

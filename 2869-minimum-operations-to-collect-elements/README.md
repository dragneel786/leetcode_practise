...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,1,5,4,2], k = 2
...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,1,5,4,2], k = 5
...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,2,5,3,1], k = 3
<strong>Output:</strong> 4

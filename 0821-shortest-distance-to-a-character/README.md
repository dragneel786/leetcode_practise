...
<pre style="position: relative;"><strong>Input:</strong> s = "loveleetcode", c = "e"
...
<pre style="position: relative;"><strong>Input:</strong> s = "aaab", c = "b"

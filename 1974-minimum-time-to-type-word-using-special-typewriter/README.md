...
<pre style="position: relative;"><strong>Input:</strong> word = "abc"
...
<pre style="position: relative;"><strong>Input:</strong> word = "bza"
...
<pre style="position: relative;"><strong>Input:</strong> word = "zjpc"

...
<pre style="position: relative;"><strong>Input:</strong> nums = [0,1,1,3], maximumBit = 2
...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,3,4,7], maximumBit = 3
...
<pre style="position: relative;"><strong>Input:</strong> nums = [0,1,2,2,5,7], maximumBit = 3

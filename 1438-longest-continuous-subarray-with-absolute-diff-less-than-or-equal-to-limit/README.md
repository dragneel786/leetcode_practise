...
<pre style="position: relative;"><strong>Input:</strong> nums = [8,2,4,7], limit = 4
...
<pre style="position: relative;"><strong>Input:</strong> nums = [10,1,2,4,7,2], limit = 5
...
<pre style="position: relative;"><strong>Input:</strong> nums = [4,2,2,2,4,4,2,2], limit = 0

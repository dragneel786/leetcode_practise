...
<pre style="position: relative;"><strong>Input:</strong> cpdomains = ["9001 discuss.leetcode.com"]
...
<pre style="position: relative;"><strong>Input:</strong> cpdomains = ["900 google.mail.com", "50 yahoo.com", "1 intel.mail.com", "5 wiki.org"]

...
<pre style="position: relative;"><strong>Input:</strong> cost = [1,2,3]
...
<pre style="position: relative;"><strong>Input:</strong> cost = [6,5,7,9,2,2]
...
<pre style="position: relative;"><strong>Input:</strong> cost = [5,5]

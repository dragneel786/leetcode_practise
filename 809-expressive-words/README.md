...
<pre style="position: relative;"><strong>Input:</strong> s = "heeellooo", words = ["hello", "hi", "helo"]
...
<pre style="position: relative;"><strong>Input:</strong> s = "zzzzzyyyyy", words = ["zzyy","zy","zyy"]

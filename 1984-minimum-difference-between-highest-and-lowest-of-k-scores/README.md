...
<pre style="position: relative;"><strong>Input:</strong> nums = [90], k = 1
...
<pre style="position: relative;"><strong>Input:</strong> nums = [9,4,1,7], k = 2
...
The minimum possible difference is 2.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,2,4,4,4,4], m = 1, k = 3
...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,2,1,2,1,1,1,3], m = 2, k = 2
<strong>Output:</strong> true
...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,2,1,2,1,3], m = 2, k = 3

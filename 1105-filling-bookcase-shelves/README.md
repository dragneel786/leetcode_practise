...
<pre style="position: relative;"><strong>Input:</strong> books = [[1,1],[2,3],[2,3],[1,1],[1,1],[1,1],[1,2]], shelf_width = 4
...
<pre style="position: relative;"><strong>Input:</strong> books = [[1,3],[2,4],[3,2]], shelfWidth = 6

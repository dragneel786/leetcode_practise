...
<pre style="position: relative;"><strong>Input:</strong> damage = [2,7,4,3], armor = 4
...
<pre style="position: relative;"><strong>Input:</strong> damage = [2,5,3,4], armor = 7
...
<pre style="position: relative;"><strong>Input:</strong> damage = [3,3,3], armor = 0
<strong>Output:</strong> 10
<strong>Explanation:</strong> One optimal way to beat the game starting at 10 health is:

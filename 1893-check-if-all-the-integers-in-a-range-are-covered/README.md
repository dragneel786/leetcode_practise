<h2><a href="https://leetcode.com/problems/check-if-all-the-integers-in-a-range-are-covered/">1893. Check if All the Integers in a Range Are Covered</a></h2><h3>Easy</h3><hr><div><p>You are given a 2D integer array <code>ranges</code> and two integers <code>left</code> and <code>right</code>. Each <code>ranges[i] = [start<sub>i</sub>, end<sub>i</sub>]</code> represents an <strong>inclusive</strong> interval between <code>start<sub>i</sub></code> and <code>end<sub>i</sub></code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> ranges = [[1,2],[3,4],[5,6]], left = 2, right = 5
...
<pre style="position: relative;"><strong>Input:</strong> ranges = [[1,10],[10,20]], left = 21, right = 21
